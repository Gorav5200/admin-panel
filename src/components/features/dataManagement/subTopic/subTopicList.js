...
export default function SubTopicList({ data, comp, columns,placeholder,path,loading ,editFun}) {
  ...
  return (
    <>
      <div className="p-1 mb-2 flex justify-between items-center gap-4 sticky top-0  ">
